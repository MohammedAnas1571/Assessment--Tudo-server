...
exports.verifyToken = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = jsonwebtoken_1.default.verify(token, process.env.TOKEN);
        req.user = user;
        next();
    }
    catch (err) {
        return next(new appError_1.default("Session expired or invalid. Please sign in again.", 401));
    }
}));
